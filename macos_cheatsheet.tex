...
\begin{center}
	...
	\begin{multicols}{2}
		...
		\begin{tabular}{*{2}{l}}
			...
			\keys{\cmd{} + ,}                                                                                 & Preferences                      \\ \midrule  % chktex 26
		...
		\begin{tabular}{*{2}{l}}
			...
			\keys{\ctrl{} + \Alt{} + + U} / \keys{I} ; \keys{J} / \keys{K}                                                  & Top L / R ; Bottom L / R  \\ \midrule % chktex 26
		...
		\begin{tabular}{*{2}{l}}
			...
			\keys{\cmd{} + ]} / \keys{[}                                  & Indent / outdent line    \\ \midrule % chktex 9 chktex 10 chktex 15
		...
		\begin{tabular}{*{2}{l}}
			...
			\keys{\Alt{} + .}                                             & Hide/show hidden files           \\ \midrule % chktex 26
